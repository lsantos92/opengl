...
static void load_GL_VERSION_3_3(GLADloadproc load) {
	...
	glad_glVertexAttribDivisor = (PFNGLVERTEXATTRIBDIVISORARBPROC)load("glVertexAttribDivisor");
...
static void load_GL_VERSION_4_0(GLADloadproc load) {
	...
	glad_glMinSampleShading = (PFNGLMINSAMPLESHADINGARBPROC)load("glMinSampleShading");
	glad_glBlendEquationi = (PFNGLBLENDEQUATIONPROC)load("glBlendEquationi");
	glad_glBlendEquationSeparatei = (PFNGLBLENDEQUATIONSEPARATEPROC)load("glBlendEquationSeparatei");
	glad_glBlendFunci = (PFNGLBLENDFUNCPROC)load("glBlendFunci");
	glad_glBlendFuncSeparatei = (PFNGLBLENDFUNCSEPARATEPROC)load("glBlendFuncSeparatei");
